...
document.addEventListener('DOMContentLoaded', function() {
  var orderButtons = document.querySelectorAll('.table-btn.hvr-underline-from-center#orderButton');

  orderButtons.forEach(function(button) {
      button.addEventListener('click', function(e) {
          e.preventDefault();
          
          let phoneNumber = '918788209773'; // Added country code 91 for India
